...
**PROCABLE REF10 ROJO C PV 6mm Cu(FLEX) XLPE SR 1800V 90°C PVC** · referencia **Procable** para sistemas fotovoltaicos. Resumen elaborado a partir de información pública del fabricante; confirme número de parte, revisión de firmware y compatibilidad de campo antes de comprar.
