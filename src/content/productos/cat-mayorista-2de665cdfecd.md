...
price: "$15.063.750"
specifications:
  - "Potencia y número de MPPT según modelo (trifásico GC)"
...
brand: "Solis"
model: "SOLIS INVERSOR S5-GC20K-LV-$ SOLIS 25 KW 220V TRIFASICO-$ SOLIS INVERSOR"
stock: "disponible"
order: 5087
---

**SOLIS INVERSOR S5-GC20K-LV-$ SOLIS 25 KW 220V TRIFASICO-$ SOLIS INVERSOR S6-GC3P30K04-LV-ND** · referencia **Solis** para sistemas fotovoltaicos. Resumen elaborado a partir de información pública del fabricante; confirme número de parte, revisión de firmware y compatibilidad de campo antes de comprar.
